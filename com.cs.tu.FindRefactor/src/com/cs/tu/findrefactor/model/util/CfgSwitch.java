...
public class CfgSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CfgPackage.MCONTROL_FLOW_GRAPH: {
				MControlFlowGraph mControlFlowGraph = (MControlFlowGraph)theEObject;
				T result = caseMControlFlowGraph(mControlFlowGraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CfgPackage.ABSTRACT_NODE: {
				AbstractNode abstractNode = (AbstractNode)theEObject;
				T result = caseAbstractNode(abstractNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CfgPackage.NODE: {
			...
			case CfgPackage.CONDITIONAL_NODE: {
			...
			case CfgPackage.ITERATIVE_NODE: {
				IterativeNode iterativeNode = (IterativeNode)theEObject;
				T result = caseIterativeNode(iterativeNode);
				if (result == null) result = caseAbstractNode(iterativeNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CfgPackage.EXPRESSION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MControl Flow Graph</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MControl Flow Graph</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMControlFlowGraph(MControlFlowGraph object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Iterative Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Iterative Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIterativeNode(IterativeNode object) {
		return null;
	}
